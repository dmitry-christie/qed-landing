...
Object.assign(window.QED_ES = window.QED_ES || {}, {
  "cel.title": "QED para Celebraciones · El juego de fiesta que se lleva el show",
  "cel.metadesc": "Un pub quiz escrito sobre el homenajeado. Cumpleaños, bodas y aniversarios presenciales en Valencia, Madrid, Murcia y Santiago de Compostela.",
  "cel.ogtitle": "QED para Celebraciones · El juego de fiesta que se lleva el show",
  "cel.ogdesc": "Trivia personalizada sobre la cumpleañera, la feliz pareja o la efeméride. No un quiz genérico.",
  ...
  "cel.ev.2s": "novia vs novio",
  "cel.ev.3t": "Aniversarios",
  "cel.ev.3d": "Rondas nostálgicas y temáticas ambientadas en el año en que todo empezó. La canción número uno, el precio de una caña, los titulares. Un brindis disfrazado de noche de quiz.",
  "cel.ev.3s": "el año de",

  "cel.fmt.eyebrow": "Dos formas de jugar",
  "cel.fmt.h2": "Lo montamos nosotros, o lo montas tú.",
  "cel.fmt.lead": "El mismo quiz personalizado. Tú eliges cuánto quieres implicarte el día del evento.",
  ...
  "cel.fmt.flatnote": "Cada quiz se escribe desde cero sobre el homenajeado.",
  "cel.fmt.flatlink": "Organiza mi evento",

  "cel.how.eyebrow": "Cómo funciona",
  "cel.how.h2": "Del grupo de WhatsApp a la noche de juego en tres pasos.",
  ...
  "cel.feat.f0d": "El homenajeado, la pareja, la efeméride. Preguntas personales que solo vuestra gente sabría responder, nunca un pack de pub reciclado.",
  ...
  "cel.feat.f3d": "Su nombre, sus fotos y sus colores en la pantalla grande. Parece que la noche se hizo para ellos.",
  ...
  "cel.faq.a4": "Puede serlo. Dinos cómo es el público y lo enfocamos en consecuencia: para todas las edades en un cumpleaños familiar, o un poco más picante para una noche estilo despedida.",
  ...
  "cel.faq.a6": "Dos semanas nos dan tiempo para escribir un quiz de verdad personal. ¿Lo tienes más justo? Pregunta igualmente, siempre intentamos encajarlo.",
  ...
  "cel.form.successp": "Gracias. Tenemos los detalles y te escribirá una persona de verdad de QED, normalmente el mismo día.",
