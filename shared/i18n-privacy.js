...
Object.assign(window.QED_ES = window.QED_ES || {}, {
  ...
  "pr.who.p": "Este sitio lo gestiona Tardeo de Trivia SL (CIF B88885199), responsable del tratamiento de tus datos personales. Para cualquier cuestión de privacidad, escríbenos a ",
  ...
  "pr.cookies.p": "Usamos unas pocas cookies propias y almacenamiento del navegador, más tecnologías de analítica y publicidad que solo se cargan tras tu consentimiento. El almacenamiento necesario siempre está activo; el resto está desactivado hasta que lo permites. Puedes revisar o cambiar tu elección cuando quieras:",
  "pr.cookies.manage": "Gestionar preferencias de cookies",

  "pr.ck.name": "Nombre",
  "pr.ck.cat": "Categoría",
  "pr.ck.purpose": "Finalidad",
  "pr.ck.dur": "Duración",
  "pr.ck.prov": "Proveedor",
  "pr.ck.first": "Propia",
  "pr.ck.r1p": "Guarda tu elección de cookies para no volver a preguntar.",
  "pr.ck.r1d": "1 año",
  "pr.ck.r2p": "Recuerda tu idioma entre páginas.",
  "pr.ck.r2d": "1 año",
  "pr.ck.r3p": "Recuerda que cerraste el aviso del sitio (solo en versiones de prueba).",
  "pr.ck.r3d": "1 año",
  "pr.ck.r4p": "Medición anónima de cómo funcionan el sitio y las campañas.",
  "pr.ck.r4d": "Hasta 1 año",
  "pr.ck.r5p": "Guarda un identificador de clic para relacionar campañas con resultados.",
  "pr.ck.r5d": "90 días",
  ...
  "pr.share.li3": "Segment: analítica que dirige la medición a las herramientas de abajo.",
  ...
  "pr.rights.p": "Puedes pedirnos acceder, rectificar, suprimir o portar tus datos, oponerte a su tratamiento o limitarlo, y retirar tu consentimiento en cualquier momento, con el botón de arriba para las cookies o escribiéndonos. También puedes reclamar ante la Agencia Española de Protección de Datos (AEPD).",
