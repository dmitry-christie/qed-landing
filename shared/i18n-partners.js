...
Object.assign(window.QED_ES = window.QED_ES || {}, {
  ...
  "p.model.lead": "Una pequeña cuota de alta, la plataforma sin coste añadido, 250 € al mes en anuncios durante los primeros 3 meses, y un 17% de las entradas. Sin sorpresas escondidas en el contrato.",
  ...
  "p.rev.r1": "de las entradas de tus tardeos semanales, vengan de donde vengan.",
  "p.rev.r2": "de los patrocinios locales que consigas.",
  "p.rev.r3": "de los eventos privados que cierres tú.",
  "p.rev.r4": "de los eventos privados que te traigamos nosotros.",
  "p.rev.volume": "Y baja con el volumen: a partir de 1.500 asistentes al mes las entradas pasan al 15%, y a partir de 10 eventos privados al mes bajan al 30% y al 22%.",
  "p.rev.note": "Todo lo demás del tardeo es tuyo. Solo crecemos cuando tú creces.",
  "p.rev.legal": "Comisiones vigentes a agosto de 2026. Las condiciones completas se recogen en el contrato de franquicia y en la información precontractual que te entregamos antes de firmar.",
  ...
  "p.deal.q4": "Alta, formación y configuración de marca completos",
  "p.deal.q5": "Soporte con respuesta en menos de 24 horas",
  ...
  "p.case.p": "El Hachazo se lanzó en Murcia y Madrid el mismo mes. En junio, el circuito de Murcia atrajo a 125 asistentes y Madrid atrajo a 134.",
